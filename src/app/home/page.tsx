...
export default function HomePage() {
  ...
  useEffect(() => {
    // Guard: if no name, send back to / to enter one
  ...
  // Render nothing until client has confirmed name exists
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-6 text-center" style={{ zIndex: 5 }}>
        ...
        {/* Change name — clears session and goes back to / */}
        <button
