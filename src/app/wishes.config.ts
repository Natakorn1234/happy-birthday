...
export const customWishes: CustomWish[] = [
  ...
  
  {
    ...
    lines: [
      "ไม่รู้จะอวยพรไร",
      "ขอให้อยุ่กับกิวนาน ๆ อย่าทะเลาะกันเยอะ",
      "",
    ...
    lines: [
      ...
      "ขอให้ผ่านทุกอย่างไปได้แบบไม่เหนื่อยเกินไป",
      "",
      "ขอบคุณมิตรภาพ BS PHOTO",
      "ขอให้เป็นผุ้นำที่ดีจนหมดวาระ",
      "",
      "ขอให้ได้มหาลัยที่ใช่",
      "รวย ๆ ใช้เงินไม่ทัน #รวยไม่ไหวแล้ว"
    ],
    closing: "ขอบคุณที่อ่านจนจบ กุใช้ ChatGPT",
  },
