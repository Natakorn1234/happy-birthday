...
const MESSAGES = [
  {
    text: "ขอให้ใจสงบขึ้น และยิ้มได้ง่ายขึ้น",
    emoji: "😊✨",
    color: "#ff6b6b",
  },
  {
    text: "ขอให้ชีวิตเบาลง แบบไม่ต้องฝืน",
    emoji: "🌿🙂",
    color: "#1e90ff",
  },
  {
    text: "ขอให้ความเหนื่อยค่อย ๆ หายไปเอง",
    emoji: "🌙💙",
    color: "#6c5ce7",
  },
  {
    text: "ขอให้มีวันที่รู้สึกว่า วันนี้โอเคนะ",
    emoji: "☀️🙂",
    color: "#00d2d3",
  },
  {
    text: "ขอให้ยังมีแรงเดินต่อ แม้ไม่ง่าย",
    emoji: "💪🌱",
    color: "#2ecc71",
  },
  {
    text: "ขอให้ได้เจอคนที่อยู่ด้วยแล้วสบายใจ",
    emoji: "🤍🌿",
    color: "#e84393",
  },
  {
    text: "ขอให้ชีวิตดีขึ้น แบบไม่ต้องรีบ",
    emoji: "🌊😌",
    color: "#1abc9c",
  },
  {
    text: "ขอให้ความฝันยังอยู่ใกล้ขึ้นทุกวัน",
    emoji: "✨🌙",
    color: "#f39c12",
  },
  {
    text: "ขอให้มีช่วงเวลาธรรมดาที่รู้สึกดี",
    emoji: "☕🙂",
    color: "#81ecec",
  },
  {
    text: "ขอให้สิ่งที่ตั้งใจ ค่อย ๆ เติบโต",
    emoji: "📈🌿",
    color: "#27ae60",
  },
  {
    text: "ขอให้หัวใจยังอ่อนโยนเสมอ",
    emoji: "🤍🌸",
    color: "#d6c6ff",
  },
  {
    text: "ขอให้เป็นตัวเองได้แบบสบายใจ",
    emoji: "🫶✨",
    color: "#fd79a8",
  },
  {
    text: "ขอให้วันธรรมดา… ไม่หนักเกินไป",
    emoji: "🌤️",
    color: "#a29bfe",
  },
];
    ...
    >
      ...
      <div className="text-center mb-6 relative z-10">
        ...
        <p className="text-white opacity-50 text-sm mt-1">
          หัวใจถูกเติมเพิ่มแล้ว {count} ครั้ง ✨ {count > 5 ? "อ่านซ้ำได้เท่าที่ใจต้องการ 🌙" : ""}
        </p>
      </div>
      ...
      >
        {isAnimating ? "✨ กำลังจัดคำดี ๆ ให้..." : "ยังอยากฟังอยู่..."}
      </button>
      ...
      {showNextHint && (
        ...
        >
          <p className="text-white opacity-70 text-sm mb-3">
            ยังมีอีกอย่าง… ที่อยากให้คุณเห็น
          </p>
          <button
