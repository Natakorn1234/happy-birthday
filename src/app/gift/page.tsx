...
const MESSAGES = [
  {
    text: "ขอให้ปีนี้ใจสงบขึ้น และยิ้มได้ง่ายกว่าเดิม",
    emoji: "😊✨",
    color: "#ff6b6b",
  },
  {
    text: "ขอให้พบเจอแต่สิ่งดี ๆ และใช้ชีวิตอย่างสบายใจ",
    emoji: "🌿🙂",
    color: "#1e90ff",
  },
  {
    text: "ขอให้ความเหนื่อยค่อย ๆ เบาลงทีละน้อย",
    emoji: "🌙💙",
    color: "#6c5ce7",
  },
  {
    text: "ขอให้มีวันที่รู้สึกว่า วันนี้ก็ดีเหมือนกัน",
    emoji: "☀️🙂",
    color: "#00d2d3",
  },
  {
    text: "ขอให้ยังมีแรงก้าวต่อไป แม้ในวันที่ไม่ง่าย",
    emoji: "💪🌱",
    color: "#2ecc71",
  },
  {
    text: "ขอให้ได้พบคนที่อยู่ด้วยแล้วสบายใจ",
    emoji: "🤍🌿",
    color: "#e84393",
  },
  {
    text: "ขอให้ชีวิตค่อย ๆ ดีขึ้น โดยไม่ต้องเร่งรีบ",
    emoji: "🌊😌",
    color: "#1abc9c",
  },
  {
    text: "ขอให้ความฝันยังอยู่ และเข้าใกล้ขึ้นทุกวัน",
    emoji: "✨🌙",
    color: "#f39c12",
  },
  {
    text: "ขอให้มีช่วงเวลาธรรมดา ที่สุขพอสำหรับหัวใจ",
    emoji: "☕🙂",
    color: "#81ecec",
  },
  {
    text: "ขอให้สิ่งที่ตั้งใจไว้ เติบโตทีละน้อย",
    emoji: "📈🌿",
    color: "#27ae60",
  },
  {
    text: "ขอให้หัวใจยังอ่อนโยน ไม่ว่าเจออะไร",
    emoji: "🤍🌸",
    color: "#d6c6ff",
  },
  {
    text: "ขอให้เป็นตัวเองได้อย่างสบายใจ",
    emoji: "🫶✨",
    color: "#fd79a8",
  },
];
